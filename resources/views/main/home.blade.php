...
<div class="body-gradient">
    <nav class="navbar navbar-expand-lg navbar-light">
        <a class="navbar-brand nav-text" href="#">Navbar</a> 
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <button class="btn btn-outline-success my-2 my-sm-0">Regist Now</button>
        </div>
    </nav>
...
<div class="m-10">
        ...
        <div class="row">
            <div class="col-sm">
                <div class="jumbotron">
                    <h1 class="display-4 jumbotron-text">UBAYA ESPORT LEAGUE SEASON 2</h1>
                    <p>
